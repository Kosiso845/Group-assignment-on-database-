...
(2, 2, 2, '2025-04-02 14:00:00'),
(3, 3, 3, '2025-04-03 09:30:00'),
(4, 4, 4, '2025-04-04 10:45:00'),
(5, 5, 5, '2025-04-05 16:00:00');
CREATE ROLE 'admin';
CREATE ROLE 'client';
...
GRANT SELECT ON bookstoreDB.* TO 'student';
...
CREATE USER 'student'@'guest_device' IDENTIFIED BY 'student_password';
...
GRANT 'STUDENT' TO 'guest'@'student_device';

SET DEFAULT ROLE 'admin' FOR 'admin'@'admin_pc';
SET DEFAULT ROLE 'client' FOR 'client'@'client_device';
SET DEFAULT ROLE 'employee' FOR 'employee1'@'employee1_laptop';
SET DEFAULT ROLE 'employee' FOR 'employee2'@'employee2_laptop';
SET DEFAULT ROLE 'STUDENT' FOR 'STUDENT'@'guest_device';
